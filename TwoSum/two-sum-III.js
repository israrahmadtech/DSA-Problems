function twoSumThree(numbers) {
    ...
    for (let i = 0; i < numbers.length -2; i++) {
        if(numbers[i] > 0 || numbers[numbers.length-1] < 0) break
...
function practiceTwoSumIII(numbers){
    numbers.sort((a, b) => a-b)
    let sum
    const triplets = []
    let j;
...
console.log(practiceTwoSumIII([-1, 0, 1, 2, -1, -4]));
console.log(practiceTwoSumIII([0, 1, 1]));
console.log(practiceTwoSumIII([0, 0, 0]));